...
public class Assets {
	...
	public static Texture robot_2;
	public static Texture robot_3;
	...
	public static void load () {
		...
		alien = loadTexture("data/alien.png");

		mainMenu = new TextureRegion(items, 0, 224, 300, 80);
...
//		bobHit = new TextureRegion(items, 128, 128, 32, 32);
		...
		bobJump = new Animation(1.2f, new TextureRegion(robot_2, 0, 0, 50, 50));
		bobFall = new Animation(1.2f, new TextureRegion(robot_3, 0, 0, 50, 50));
		bobHit = new TextureRegion(robot_2, 0, 0, 50, 50);

//		squirrelFly = new Animation(0.2f, new TextureRegion(items, 0, 160, 32, 32), new TextureRegion(items, 32, 160, 32, 32));
		squirrelFly = new Animation(0.2f, new TextureRegion(alien, 0, 0, 30, 30));
...
//			new TextureRegion(items, 64, 192, 64, 16), new TextureRegion(items, 64, 208, 64, 16));
		brakingPlatform = new Animation(0.2f, new TextureRegion(items, 64, 208, 64, 16));
		platform = new TextureRegion(floor, 0, 0, 43, 6);
